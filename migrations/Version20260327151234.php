 ...
 */
final class Version20260327151234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_lesson (id INT AUTO_INCREMENT NOT NULL, is_validated TINYINT NOT NULL, validated_at VARCHAR(255) DEFAULT NULL, user_id INT NOT NULL, lesson_id INT NOT NULL, INDEX IDX_9D266FCEA76ED395 (user_id), INDEX IDX_9D266FCECDF80196 (lesson_id), UNIQUE INDEX user_lesson_unique (user_id, lesson_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
